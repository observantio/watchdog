"""SQLAlchemy DB models and session for the gateway-auth-service.

Moved from `main.py` during refactor so the FastAPI app file is thin and
only responsible for wiring routers and the application lifecycle.
"""
