...
class ChannelStorageService:
    ...
    def get_notification_channels(
        ...
        with get_db_session() as db:
            ...
            for ch in channels:
                ...
                if _has_access(ch.visibility or "private", ch.created_by, user_id, shared_group_ids, group_ids):
    ...
    def get_notification_channel(
        ...
        with get_db_session() as db:
            ...
            if not ch or not _has_access(ch.visibility or "private", ch.created_by, user_id, [g.id for g in ch.shared_groups] if ch.shared_groups else [], group_ids):
                return None
            ch.config = decrypt_config(ch.config or {})
