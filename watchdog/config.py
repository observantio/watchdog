...
class Config:
    ...
    def __init__(self) -> None:
        ...
        self.NOTIFIER_URL: str = os.getenv("NOTIFIER_URL", "http://notifier:4323")
        self.RESOLVER_URL: str = os.getenv("RESOLVER_URL", "http://resolver:4322")
        ...
        self.NOTIFIER_TIMEOUT_SECONDS: float = float(os.getenv("NOTIFIER_TIMEOUT_SECONDS", "15.0"))
        self.RESOLVER_TIMEOUT_SECONDS: float = float(os.getenv("RESOLVER_TIMEOUT_SECONDS", "20.0"))
        ...
        self.GRAFANA_PROXY_CACHE_TTL: int = int(os.getenv("GRAFANA_PROXY_CACHE_TTL", "30"))
        ...
        self.TTL_CACHE_KEY_PREFIX: str = os.getenv("TTL_CACHE_KEY_PREFIX", "watchdog:ttl").strip()
        ...
        self.NOTIFIER_SERVICE_TOKEN: Optional[str] = os.getenv("NOTIFIER_SERVICE_TOKEN")
        ...
        self.NOTIFIER_CONTEXT_ALGORITHM: str = os.getenv("NOTIFIER_CONTEXT_ALGORITHM", "HS256").strip().upper()
        self.NOTIFIER_CONTEXT_TTL_SECONDS: int = int(os.getenv("NOTIFIER_CONTEXT_TTL_SECONDS", "90"))
        self.NOTIFIER_TLS_ENABLED: bool = _to_bool(os.getenv("NOTIFIER_TLS_ENABLED"), default=False)
        self.NOTIFIER_CA_CERT_PATH: Optional[str] = os.getenv("NOTIFIER_CA_CERT_PATH")

        self.RESOLVER_SERVICE_TOKEN: Optional[str] = os.getenv("RESOLVER_SERVICE_TOKEN")
        self.RESOLVER_CONTEXT_SIGNING_KEY: Optional[str] = os.getenv("RESOLVER_CONTEXT_SIGNING_KEY")
        self.RESOLVER_CONTEXT_ISSUER: str = os.getenv("RESOLVER_CONTEXT_ISSUER", "watchdog-main")
        self.RESOLVER_CONTEXT_AUDIENCE: str = os.getenv("RESOLVER_CONTEXT_AUDIENCE", "resolver")
        self.RESOLVER_CONTEXT_ALGORITHM: str = os.getenv("RESOLVER_CONTEXT_ALGORITHM", "HS256").strip().upper()
        self.RESOLVER_CONTEXT_TTL_SECONDS: int = int(os.getenv("RESOLVER_CONTEXT_TTL_SECONDS", "120"))
        self.RESOLVER_PROXY_CACHE_TTL_SECONDS: int = int(os.getenv("RESOLVER_PROXY_CACHE_TTL_SECONDS", "15"))
        self.RESOLVER_TLS_ENABLED: bool = _to_bool(os.getenv("RESOLVER_TLS_ENABLED"), default=False)
        self.RESOLVER_CA_CERT_PATH: Optional[str] = os.getenv("RESOLVER_CA_CERT_PATH")

        self.RESOLVER_ANALYZE_MAX_CONCURRENCY: int = int(os.getenv("RESOLVER_ANALYZE_MAX_CONCURRENCY", "4"))
        self.RESOLVER_ANALYZE_MAX_RETAINED_PER_USER: int = int(
            os.getenv("RESOLVER_ANALYZE_MAX_RETAINED_PER_USER", "50")
        )
        self.RESOLVER_ANALYZE_JOB_TTL_SECONDS: int = int(os.getenv("RESOLVER_ANALYZE_JOB_TTL_SECONDS", "900"))
