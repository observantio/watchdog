...
class ConfigSecurityTests(unittest.TestCase):
    ...
    def test_loads_secrets_from_vault_when_enabled(self):
        class FakeVaultProvider:
            ...
            def get(self, key):
                mapping = {
                    "DATABASE_URL": "postgresql://vaultuser:vaultpass@db:5432/watchdog",
        ...
        with patch.dict(os.environ, {
            ...
            self.assertEqual(module.config.DATABASE_URL, "postgresql://vaultuser:vaultpass@db:5432/watchdog")
