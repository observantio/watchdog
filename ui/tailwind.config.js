...
export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        'mono': ['Ubuntu Mono Sans', 'ui-monospace', 'SFMono-Regular', 'Menlo', 'Monaco', 'Courier New', 'monospace'],
        'sans': ['Ubuntu Mono', 'Ubuntu', 'system-ui', '-apple-system', 'Segoe UI', 'Roboto', 'Helvetica Neue', 'Arial', 'sans-serif'],
      },
      boxShadow: {
