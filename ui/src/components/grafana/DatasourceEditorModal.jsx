    ...
    <Modal
      ...
      footer={
        <div className="flex gap-3 justify-end">
          ...
          <Button variant="primary" onClick={handleSave} disabled={!String(datasourceForm.name || '').trim() || !String(datasourceForm.url || '').trim()}>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <Input value={String(datasourceForm.name || '')} onChange={(e) => setDatasourceForm({ ...datasourceForm, name: e.target.value })} placeholder={datasourceForm.type === 'prometheus' ? 'Mimir' : datasourceForm.type === 'loki' ? 'My Loki' : 'My Tempo'} required />
            </div>
            <div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="md:col-span-2">
              ...
              <Input value={String(datasourceForm.url || '')} onChange={(e) => setDatasourceForm({ ...datasourceForm, url: e.target.value })} placeholder={datasourceForm.type === 'prometheus' ? MIMIR_PROMETHEUS_URL : datasourceForm.type === 'loki' ? LOKI_BASE : TEMPO_URL} required />
            </div>
            <div>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <VisibilitySelector
              ...
              onVisibilityChange={(value) => setDatasourceForm({ ...datasourceForm, visibility: value, sharedGroupIds: [] })}
              sharedGroupIds={datasourceForm.sharedGroupIds}
              onSharedGroupIdsChange={(ids) => setDatasourceForm({ ...datasourceForm, sharedGroupIds: ids })}
              groups={groups}
            />
          </div>
        </div>
