...
export default function CreateUserModal({
  ...
  const handleCopyPassword = async () => {
    try {
      ...
      toast.error(
        "Failed to copy password: " + (err?.message || "Unknown error"),
      );
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    const { normalized, errors: newErrors } = validateCreateUserForm(formData, {
      requirePassword,
    });
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex items-center gap-3">
          <Checkbox
            checked={formData.must_setup_mfa}
            onChange={() =>
              setFormData({
                ...formData,
          ...
          <div className="max-h-48 overflow-y-auto bg-sre-surface">
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <div className="flex-1 min-w-0">
                        <div
                          className="font-semibold text-sre-text text-sm truncate"
                          title={group.name}
                        >
                          {group.name}
                        </div>
            ...
            {hasMoreGroups && (
              <div className="text-xs text-sre-text-muted text-center py-2 mt-2 border-t border-sre-border">
                Showing first 5 of {filteredGroups.length} groups. Use search to
