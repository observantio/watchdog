  ...
  useEffect(() => {
    const handler = (e) => {
      ...
      const mfaRequired = Boolean(
        challenge &&
        (challenge.mfa_setup_required === true ||
          (challenge.detail && challenge.detail.mfa_setup_required === true)),
      );
      if (status === 401 && mfaRequired) {
        ...
        error(
          "Multi‑factor setup is required — please complete 2FA setup to continue.",
        );
        return;
      }
